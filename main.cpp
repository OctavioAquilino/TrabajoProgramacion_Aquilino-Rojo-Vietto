 ...
 * Muestra n primeras provincias con mas muertes por Covid-19 en
   orden descendente si el parametro es mandado, si no se mostrará todo.
...
/**
 * Mostrará los datos de los casos que estuvieron en cuidados
   intensivos ordenados por fecha de cuidados intensivos, si fecha está indicada, 
   se mostrarán solo las fechas mayores a esta.
 ...
 * @param argc Tamaño de argumento.
